...
try {
  ...
  $backendProc = Start-ManagedProcess "backend" "set AUTH_REQUIRE_OTP=false && set AUTH_ALLOW_PASSWORD_LOGIN=true && set AUTH_ALLOW_PASSWORD_REGISTER=true && npm --prefix backend run dev"
  try {

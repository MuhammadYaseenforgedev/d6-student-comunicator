...
export default function AppShell() {
  ...
  return (
    <div className="flex min-h-full flex-col overflow-visible">
      <div className="flex w-full flex-col px-3 py-3 sm:px-4 sm:py-4 lg:px-6 lg:py-6 xl:px-8 2xl:px-10">
        ...
        <div className="desktop-app-frame grid grid-cols-1 gap-4 lg:grid-cols-[300px_minmax(0,1fr)] lg:gap-5 xl:grid-cols-[320px_minmax(0,1fr)]">
          ...
          <main className="glass-panel relative flex min-h-0 min-w-0 flex-col overflow-visible">
            <div className="sidebar-gradient-border-overlay absolute inset-0" />
            <div className="pointer-events-none absolute inset-0 opacity-100">
            ...
            <div className="relative flex flex-col p-3 sm:p-4 lg:p-6 xl:p-7">
              <AppErrorBoundary>
                <div className="relative flex min-w-0 flex-col overflow-visible">
                  <div className="app-page-scroll relative min-w-0 overflow-visible pr-0">

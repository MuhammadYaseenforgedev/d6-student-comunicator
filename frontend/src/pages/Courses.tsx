...
import LmsAccessButton from "../components/LmsAccessButton";
              ...
              return (
                ...
                >
                  ...
                  <div className="relative mt-4 flex flex-wrap items-center gap-2">
                    <LmsAccessButton />
                    <span className="rounded-full border border-[rgba(140,235,255,0.18)] bg-[rgba(8,18,48,0.52)] px-3 py-1 text-xs text-white/64">
